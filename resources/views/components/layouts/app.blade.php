...
<body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 antialiased" x-data="{
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <!-- Main Content -->
            <main class="flex-1 overflow-auto bg-white dark:bg-gray-900 content-transition">
                <div class="p-0">
                    <!-- Success Message -->
                    @session('status')
